...
PLANS = [
    (TR, 'Переклад',
     'Гра вже стоїть, лишається тільки перекласти. Це хвилина.'),
    (ENGINE, 'Переклад + OpenMW',
     'OpenMW стане поруч зі старою грою і читатиме ті самі файли. '
     'Це кілька хвилин.'),
    (MODS, 'Переклад + OpenMW + моди автора',
     'Той самий набір модів, у який грає автор перекладу. Це кілька '
     'годин і десятки гігабайтів. Ще потрібен обліковий запис '
     'на Nexus Mods.'),
]
