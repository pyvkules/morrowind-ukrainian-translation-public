...
# Лапку теж викидаємо, і не з примхи: у плагінах та сама книга приходить
# то з прямою " , то з кривими “ ” , і доти пряма лишалася, а криві
# зникали - тексти через це розходилися на рівному місці. Українська
# лапка все одно своя (§10), тож на переклад це не впливає.
